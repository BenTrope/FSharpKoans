...
module ``05: I Have Here In My Hand A List`` = 
    ...
    let ``02 Creating a list (Syntax 2).`` () =
        ...
        let myLastList =  "naartjie" ::"raisin" :: myList           // DO NOT use [ or ] symbols on this 
        myList |> should equal [ "apple"; "grape"; "pear"; "biscuit" ]
    ...
    let ``07 Pattern-matching a list (Part 3).`` () =
        let fruits = ["apple"; "peach"; "orange"; "watermelon"; "pineapple"; "tomato"]
        let _::d::e = fruits
        d |> should equal  "peach"                                                                                          //GRABS 2nd
        e |> should equal  [ "orange"; "watermelon"; "pineapple"; "tomato"]                                                 // GRABS LAST 4 ELEMENTS

    [<Test>]
    let ``08 Pattern-matching a list (Part 4).`` () =
        let fruits = ["apple"; "peach"; "orange"; "watermelon"; "pineapple"; "tomato"]
        let f::_::_::g::_ = fruits                                                                                           //TOP & MIDDLE
    ...
    let ``10 Pattern-matching a list (Part 6).`` () =
        let fruits = ["apple"; "peach"; "orange"; "watermelon"; "pineapple"; "tomato"]                                      // let [obj1 ; obj2 ; obj3; obj3] = AlreadExistingList
    ...
    let ``14 Creating a list containing a sequence of numbers, and indexing`` () =
        let k = [6..50]
        let l = [3..3..20]
        k.[3] |> should equal 9 //9
        l.[3] |> should equal 12 //12